...
/// Soal - 01 Sisa Gaji
let gundam = 750000, makan = 2000000, kost = 1000000, subcription = 250000; // Declare Variable and Value of Spent
...
pengeluaran = gundam + makan + kost + subcription; // Calculate Expense
...
/// Soal - 02
/// Gunakan operator yang tepat untuk mengetahui apakah 2 variabel dibawah ini memiliki nilai yang sama (tipe data tidak termasuk)
const oneInString = "1"; // Declare Variable with value
const oneInNumber = 1; // Declare Variable with value
const isSame = oneInString == oneInNumber; // Comparing value with their data type
...
const isHigher = studentA >= studentB; // Comparing value with their data type
...
const final = oneInNumber === oneInString; // Comparingn value with their data type
console.log(final);