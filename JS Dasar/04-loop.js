...
while (primeCounter < 50) {
    ...
    // kondisi jika isPrime true
    if (isPrime == true) {
        fiftiethPrime = n // store value variable fiftiehPrime dengan value n jika isPrime true
        primeCounter++ // menambahkan perulangan ke- untuk bilangan prima
    }
    n++ // tambahkan n untuk cek setiap bilangan
}
console.log(fiftiethPrime); // mencetak output
...
while (oddCounter < 50)
console.log(fiftiethOdd) // mencetak output